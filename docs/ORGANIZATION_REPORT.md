...
1. **Golden Ratio / Fibonacci quantitative research platform** — defined in `docs/02-project/PHI_PRD.md`, `docs/03-architecture/SYSTEM_ARCHITECTURE.md`, `docs/04-research/RESEARCH_HYPOTHESES.md`, `docs/04-research/VALIDATION_CHECKLIST.md`. This is extensively developed (448-line PRD with named hypotheses, 12 φ-feature families, a mandatory 6-category control/placebo framework, phase plan) and consistently cross-referenced across those four documents.
